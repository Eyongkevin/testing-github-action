...
LOGGING = {
    ...
    "loggers": {
        "logging_mw": {
            ...
            "level": "DEBUG",  # filter debug and above
        },
    },
    "handlers": {
        "console": {  # name of the handler, could be anything that makes sense
            "level": "DEBUG",  # log level DEBUG and higher
            "class": "logging.StreamHandler",  # a logging class gotton from the logging library
